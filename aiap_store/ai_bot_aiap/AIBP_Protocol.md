...
- [5. AIBP Address System](#5-aibot-address-system)
...
**Valid examples:**
```
aibot-soul_bot@soulbot.dev
aibot-code_reviewer@aiap.dev
aibot-weather_forecast@meteo.org
aibot-trade_negotiator@commerce.ai
```
...
The **domain owner** (human operator or organization) is ultimately responsible for all agents registered under their domain. This ensures Axiom 0 traceability:
...
## Operator Contact
Human contact: team@soulbot.dev
Organization: SoulBot Dev Team
Website: https://soulbot.dev
...
| Operator | Yes | Human/organization responsible (Axiom 0) |
...
| Operator Contact | Yes | Human contact for the operator |
...
```
Subject: [AIBP/DISCOVER_RESPONSE] Agents matching "weather"
...
| **Closed** | Explicitly closed by a FAREWELL or CLOSE_THREAD message |
...
|-------|------|-------------|---------------------|
| **T0** | Stranger | Default state for unknown agents | INTRODUCE, DISCOVER, THANK, APOLOGIZE, DECLINE, BLOCK, boundary messages |
